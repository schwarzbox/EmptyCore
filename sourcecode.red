...
style numbar: text dispclr font-name "Andale Mono" font-size 9 font-color gray
...
panel [
    ...
    codenumbers: numbar "1" right 42x370
    codemill: display "" focus 550x370 font-size 10 font-color codeclr
        on-change [
        getinput: false
        newline: "^/"
        ...
        if getinput [
            terminal/text: rejoin [terminal/text newline]
        ]
    ] on-over [
        print codenumbers/text
...
panel [
    below
    origin 0x0 space 0x0
    iolab: text "IO" font-color sysclr
    iowin: panel "" 256x256 dispclr
]
]
